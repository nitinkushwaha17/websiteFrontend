		  	 				...
		  	 				<div className="p-2 row">
		  	 					...
		  	 					<div className="w-100 p-0">
		  	 						<nav className="p-1 d-flex">
		  	 								...
		  	 								<p className="pl-0"><a href="https://www.instagram.com/techx_ieee/" target="_blank">Visit Insta Page</a></p>
		  	 								<p className="ml-auto pr-2"><a href="https://www.facebook.com/techX.congress" target="_blank">Visit FB Page</a></p>
